...
{
    // read the txt generated by merge_static.py, which store the entire map merged with the poses in global frame
    std::ifstream myfile("/home/tingxfan/rerun-4DMOS/4DMOS_gt00.txt");
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr basic_cloud_ptr(new pcl::PointCloud<pcl::PointXYZI>); // original pointcloud
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr cloud_filtered(new pcl::PointCloud<pcl::PointXYZI>); // filtered pointcloud
    ...
    // save pcd
    pcl::io::savePCDFileBinary(string("4DMOS_gt00.pcd"), *cloud_filtered);
